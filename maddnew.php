...
{
  if (!$con->query("insert into useraccounts (name,SSN,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[SSN]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          ...
          <th>SSN</th>
          <td><input type="number" name="SSN" class="form-control input-sm" required></td>
        </tr>
        <tr>
