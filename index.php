...
<body style="background:#0D4F8B;background-size: 100%">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to Happy Bank!</h4>
  <p  class="lead alert alert-primary"><b>Latest Notification:</b>
  ...
  <?php 
      ...
      if ($array->num_rows > 0)
      {
        ...
        echo "<div class='alert alert-success'>Notice box empty</div>";
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/one.jpg" alt="First slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/two.jpg" alt="Second slide" style="max-height: 250px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/three.jpg" alt="Third slide" style="max-height: 250px">
          </div>
    ...
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/acc.jpeg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/money.png" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
